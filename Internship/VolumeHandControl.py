...
while True:
    ...
    lmlist = detector.positionFinder(image, 0,draw=False)
    ...
    cv2.putText(image, f'{int(volPer)} %',(40,50), cv2.FONT_HERSHEY_COMPLEX, 1, (0,255,0), 3)

    ctime = time.time()
    fps = 1/(ctime-ptime)
    ptime = ctime

    cv2.putText(image, f'FPS: {int(fps)}', (40,50), cv2.FONT_HERSHEY_COMPLEX, 1, (255,0,255), 3)
